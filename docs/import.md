...
## Viewing DICOM Data
The TPS displays three orthogonal views by default. To change the layout, click the grey square icon in the module tab ![fourup 2](img/fourup.png){ width="30" } and select the desired view; the default layout is Four-Up.
